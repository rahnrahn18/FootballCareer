...
fun BusinessScreen(
    player: Player,
    onBuy: (String) -> Unit // Changed to String ID for consistency with Shop
) {
    ...
    Column(
        ...
        Text(
            "Invest in businesses to earn weekly income. High risk means higher chance of failure/loss.",
            color = Color.Gray,
        ...
        LazyColumn(
            ...
            items(businesses) { business ->
                com.championstar.soccer.ui.screens.BusinessCard(
                    business = business,
...
@Composable
fun BusinessCard(
    business: com.championstar.soccer.data.static.Business,
    onBuy: () -> Unit
) {
    Card(
